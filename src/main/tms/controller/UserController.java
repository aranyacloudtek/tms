...
public class UserController {
    ...
    public Users updateUser(@PathVariable(value = "adid") String adid,
                                            @Valid @RequestBody Users userDetails) {

        Users user = userRepository.findById(adid)
                .orElseThrow(() -> new ResourceNotFoundException("Users", "adid", adid));
